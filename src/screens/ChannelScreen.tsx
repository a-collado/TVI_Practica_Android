...
export default function ChannelScreen({navigation}: any) {
  ...
  const [expandSecondTouchable, setExpandSecondTouchable] =
    useState<string>('');
      ...
      <FlatList
        ...
        renderItem={({item}) => (
          <View style={styles.section}>
            <TouchableOpacity
              onPress={() => onExpandTouchable(item.name)}
              ...
              <FlatList
                ...
                renderItem={({item: item2}) => (
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => onExpandSecondTouchable(item2.name)}
                      style={[
                        styles.button,
